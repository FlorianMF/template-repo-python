...
- [This PR](https://github.com/AUTHOR_NAME/PACKAGE_NAME/pull/2671) is a good example for adding a new metric, and [this one for a new logger](https://github.com/GITHUB_NAME/REPONAME/pull/2721)
